...
sys.path.append(os.path.join(os.getcwd(), 'incl'))
sys.path.append(os.path.join(os.getcwd(), 'incl', 'utils'))
...
def main(_):
    # TODO: if AttributeError: gpus occors, uncomment incl/utils.py flags.DEFINE_string
